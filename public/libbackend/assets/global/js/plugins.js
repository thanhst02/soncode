    ...
    if($('.form-validation').length && $.fn.validate){
        ...
        $('.form-validation').each(function(){
            var formValidation = $(this).validate({
                success: "valid",
                submitHandler: function() { alert("Xác nhập đăng ký tài khoản!") },
                ...
                messages:{
                    ...
                    email: {required: 'Nhập địa chỉ email!', customemail: 'Nhập địa chỉ email hợp lệ!'},
                    language: {required: 'Enter your language'},
                    mobile: {required: 'Nhập số điện thoại'},
                    avatar: {required: 'Tải lên hình đại diện'},
                    password: {required: 'Nhập mật khẩu'},
                    password2: {required: 'Nhập lại mật khẩu',equalTo: 'Mật khẩu không trùng khớp'},
