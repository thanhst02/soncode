	...
	<div class="col-lg-12 portlets">
		<div class="panel">
			<div class="panel-header md-panel-controls">
				<h3><i class="fa fa-table"></i> <strong> Thêm mục phân loại mới </strong></h3>
			</div>
			<div class="panel-content pagination2 table-responsive">
				<div class="row">
					<div class="col-lg-12">
						{!! Form::open(['method' => 'POST', 'route' => ['backend.category.update', $category->id], 'enctype' => 'multipart/form-data', 'id' => 'add-category']) !!}
						{{ method_field('PATCH') }}
							<div class="col-md-12">
								<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
									{!! Form::label('name', 'Tên phân loại', ['class' => 'required']) !!}
									{!! Form::text('name', old('name')?old('name'):$category->name, ['class' => 'form-control form-control-success', 'placeholder' => 'Tên loại', 'required' => 'required']) !!}
							...
							<div class="col-md-12">
								<div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
									...
									{!! Form::textarea('description', old('description')?old('description'):$category->description, ['class' => 'form-control form-control-success', 'cols' => '80', 'rows' => '10', 'placeholder' => 'Mô tả']) !!}
