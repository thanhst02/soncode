	...
	<div class="col-lg-12 portlets">
		<div class="panel">
			...
			<div class="panel-content pagination2 table-responsive">
				<div class="row">
					<div class="col-lg-12">
						{!! Form::open(['method' => 'POST', 'route' => 'backend.category.store', 'enctype' => 'multipart/form-data', 'id' => 'add-category']) !!}
							<div class="col-md-12">
								<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
									{!! Form::label('name', 'Tên phân loại', ['class' => 'required']) !!}
									{!! Form::text('name', old('name'), ['class' => 'form-control form-control-success', 'placeholder' => 'Tên loại', 'required' => 'required']) !!}
							...
							<div class="col-md-12">
								<div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
									...
									{!! Form::textarea('description', old('description'), ['class' => 'form-control form-control-success', 'cols' => '80', 'rows' => '10', 'placeholder' => 'Mô tả']) !!}
