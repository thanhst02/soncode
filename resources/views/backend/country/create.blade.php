	...
	<div class="col-lg-12 portlets">
		<div class="panel">
			...
			<div class="panel-content pagination2 table-responsive">
				<div class="row">
					<div class="col-lg-12">
						{!! Form::open(['method' => 'POST', 'route' => 'backend.country.store', 'enctype' => 'multipart/form-data', 'id' => 'add-country']) !!}
							<div class="col-md-12">
								<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
									{!! Form::label('name', 'Tên quốc gia', ['class' => 'required']) !!}
									{!! Form::text('name', old('name'), ['class' => 'form-control form-control-success', 'placeholder' => 'Tên quốc gia', 'required' => 'required']) !!}
							...
							<div class="col-md-6">
								<div class="form-group{{ $errors->has('iso_code') ? ' has-error' : '' }}">
									...
									{!! Form::text('iso_code', old('iso_code'), ['class' => 'form-control form-control-success', 'placeholder' => 'vd:Việt nam("VN")', 'required' => 'required']) !!}
							...
							<div class="col-md-6">
								<div class="form-group{{ $errors->has('country_code') ? ' has-error' : '' }}">
									...
									{!! Form::text('country_code', old('country_code'), ['class' => 'form-control form-control-success', 'placeholder' => 'vd:Việt nam("84")', 'required' => 'required']) !!}
